import { d as metadataQuery, f as parseColumns, g as tableListingSql, h as sanitizeIdentifier, i as DEFAULT_MAX_RESULT_CHARS, l as classifyStatement, m as parseTableListing, o as DEFAULT_QUERY_TIMEOUT_MS, p as parseListing, r as DEFAULT_MAX_QUERY_CHARS, t as DEFAULT_CONNECT_TIMEOUT_MS, u as clientsSchema } from "./defaults-DSPWeO3b.js";
import { t as runClientQuery } from "./query-WSTw_Cul.js";
...
function validateConnectBody(value, cwd = process.cwd()) {
	...
	if (type !== "mysql" && type !== "postgres" && type !== "sqlite" && type !== "oracle" && type !== "hive" && type !== "impala" && type !== "clickhouse" && type !== "doris" && type !== "sqlserver") throw new Error("type 必须是 \"mysql\"、\"postgres\"、\"sqlite\"、\"oracle\"、\"hive\"、\"impala\"、\"clickhouse\"、\"doris\" 或 \"sqlserver\"");
